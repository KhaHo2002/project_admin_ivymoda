...
const WeatherState = (props) => {
    ...
    const getWeatherByLocation = async (locationId) => {
        // 1236594 . woeid
        let res = await axios.post(`${process.env.REACT_APP_SERVICE_WEATHER}/get-data-by-url`, {
    ...
    const getImageUrl = (weatherState) => {
        ...
        return `${process.env.REACT_APP_SERVICE_WEATHER}/static/img/weather/${fetchState}.svg`;
    }
